    ...
    <main>
      ...
      <section className="talk-call">
        <div className="shell talk-call-inner">
          <div className="talk-copy">
            <div className="section-tag warm">THE PART THAT IS NOT A MAP</div>
      ...
      <section className="road-actions">
        <div className="shell road-actions-inner">
          <div><div className="section-tag warm">THE ROAD IS COLLABORATIVE</div><h2>Know something<br />ahead of me?</h2><p>Every one of these has its own short page, and every one reaches me.</p></div>
      ...
      <section className="partner-promo">
        <div className="shell partner-promo-inner">
          <div>
            <div className="section-tag warm">PUT YOUR NAME ON IT</div>
      ...
      <section className="book-promo">
        <div className="shell book-promo-inner">
          <div><div className="section-tag light">THE BOOK FROM THE ROAD</div><h2>A Long Walk.</h2><p>Field notes, photographs, exhaustion and conversations across India—becoming a book while the journey happens.</p><Link href="/book">Meet the book and pre-register →</Link></div>
